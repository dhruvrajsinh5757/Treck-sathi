      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            <Link to="/" className="text-xl font-bold text-white">TrekConnect</Link>
            <p className="text-sm text-slate-400">Find your perfect trek companion.</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 text-center text-sm text-slate-500">
          © {new Date().getFullYear()} TrekConnect. All rights reserved.
        </div>
      </div>
    </footer>
  );
